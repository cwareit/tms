...
@section('title')
    असाधारण विदा | {{$teacher->name}} | {{ config('app.name') }}
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">असाधारण विदा</li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-header text-center">
        <h4>असाधारण विदा | {{$teacher->name}} | {{ config('app.name') }}</h4>
    </div>
    <div class="card-body">
        <p class="text-muted">
            <small>
        ...
        <form method="post" action="#">
            ...
            <div class="mb-3">
                ...
                <input type="string" class="form-control" id="leave_from" name="leave_from" value="{{ old('leave_from') }}">
                @error('leave_from')
            ...
            <div class="mb-3">
                ...
                <input type="string" class="form-control" id="leave_to" name="leave_to" value="{{ old('leave_to') }}">
                @error('leave_to')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
