...
@section('title')
    नयाँ बढुवा नियुक्ति | {{$teacher->name}} | {{ config('app.name') }}
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">नयाँ बढुवा नियुक्ति</li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-header text-center">
        <h4>नयाँ बढुवा नियुक्ति | {{$teacher->name}} | {{ config('app.name') }}</h4>
    </div>
    <div class="card-body">
        <p class="text-muted">
            <small>
            ...
            @csrf
             ...
             <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type">
                            ...
                            <option value="७५% फायल बढुवा">७५% फायल बढुवा</option>
                            <option value="२५% आन्तरिक बढुवा">२५% आन्तरिक बढुवा</option>
                            <option value="बिशेष बढुवा">बिशेष बढुवा</option>
